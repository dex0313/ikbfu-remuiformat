...
class format_remuiformat_card_all_sections_summary implements renderable, templatable {
    ...
    private function get_card_format_context(&$export, $renderer, $editing, $rformat) {
        ...
        if ($generalsection) {
            if ($editing) {
                $export->generalsection['title'] = $this->course->fullname;//$renderer->section_title($generalsection, $this->course);
                ...
                $export->generalsection['title'] = $this->course->fullname; // $this->courseformat->get_section_name($generalsection);
            }
	   ...
	   // BUG it is a leak
           ...
           //$imgurl = $this->courseformatdatacommontrait->display_file($this->settings['remuicourseimage_filemanager']);
            ...
            //}
		//$imgurl = $this->get_course_image();
	global $CFG;
	         $course = $this->course;
	         //$course = new  \core_course_in_list($this->course);
       $imgurl =''; 
